...
export default function Client({ redirectTo }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Join StartwiseCRM",
        description: "Welcome to your CRM for startup teams. Create a secure workspace to manage clients, deals, and collaboration.",
      };
    }
    ...
    return {
      ...
      description: "Securely access your CRM workspace. Only invited team members can sign in.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary/80">
                StartwiseCRM Onboarding
              </p>
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                CRM, collaboration, and deal flow for your startup team.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Invite-only. StartwiseCRM is a private platform for internal startup use, helping your team accelerate sales and maintain secure client records.
              </p>
            </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm text-muted-foreground">
                        Ask your admin if you need a password reset
                      </span>
                    </div>
                    <Input
                      id="signin-password"
