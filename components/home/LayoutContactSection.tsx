  ...
  return (
    <section id="contact" className="container py-24 sm:py-32">
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <div className="mb-4">
            <h2 className="text-lg text-primary mb-2 tracking-wider">{contact.eyebrow}</h2>
            <h2 className="text-3xl md:text-4xl font-bold">{contact.heading}</h2>
          </div>
          <p className="mb-8 text-muted-foreground lg:w-5/6">{contact.description}</p>
                ...
                <div className="flex flex-col gap-1.5">
                  <FormField control={form.control} name="message" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea rows={5} placeholder="How can we help? StartwiseCRM support will get back shortly." className="resize-none" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
